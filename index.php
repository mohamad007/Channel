<?php
ob_start();
define('API_KEY','249281330:AAGb86u1NvkvTnQRfNsdlEihLaQk024irl4');
$the_admin_id = 208094932;
...
//                }break;
                ...
                case '7':{
                    ...
                    if($image_id === false){
                        ...
                        $fule = 'https://api.telegram.org/file/bot249281330:AAGb86u1NvkvTnQRfNsdlEihLaQk024irl4/'.trim($imag->result->file_path,"\\/");
